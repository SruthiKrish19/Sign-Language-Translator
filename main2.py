...
k=0
p=0
det=['hi','dont know','your name','stop','close','super','look','hungry','in home','call me','perfect','focus','sick','confused','thirsty ','Thank you']
detr=['how are you','i dont know','what is your name','stop it','close the door\nrelative','super impressive\nsupertechnique','lookat there','i am hungry','i am in home','call me now\ncall me immediately','This is perfect','focus on you work','sick feeling','confused state','i am very thirsty','for your help']
...
def detect(filename):
    ...
    print(m)
    word10=TextBlob(detr[prediction.index(max(prediction))])
    mn=word10.translate(from_lang='en',to='ta')
